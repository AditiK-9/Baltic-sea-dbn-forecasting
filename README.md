...
Figure 1 contains the R code written to create a Hidden Markov Model . Additional comments addressing what was written and why, has been added in the screenshot.<br>
...
**2.	Dynamic Bayesian Network (DBN)**<br>
